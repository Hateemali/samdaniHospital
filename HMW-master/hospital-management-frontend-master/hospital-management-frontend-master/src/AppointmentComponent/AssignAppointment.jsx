...
const AssignAppointment = () => {
  ...
  const retrieveAppointment = async () => {
    ...
    const response = await axios.get(
      `${baseUrl}/api/appointments/id?appointmentId=${appointmentId}`
    );
  ...
  const retrieveAllDoctor = async () => {
    //corrected
    const response = await axios.get(`${baseUrl}/api/users/doctor/all`);
  ...
  const saveAppointment = () => {
    ...
    axios
      .post(
        `${baseUrl}/api/appointment/admin/assign/doctor`,
        formData
      )
      .then((result) => {
