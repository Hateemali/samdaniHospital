...
const DoctorRegister = () => {
  ...
  const retrieveAllSpecialist = async () => {
    const response = await axios.get(
      "http://localhost:5000/api/users/doctor/specialist/all"
    );
  ...
  const saveUser = async (event) => {
    ...
    await axios
      .post("http://localhost:5000/api/users/doctor/upload", formData)
      .then((result) => {
        ...
        axios
          .post("http://localhost:5000/api/users/doctor/register", tempdict)
          .then((result) => {
